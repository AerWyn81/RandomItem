...
public class LanguageHandler {
	...
	private final RandomItem main;

	public LanguageHandler(RandomItem main, String language) {
		this.main = main;
	...
	public String checkLanguage(String lang) {
		File f = new File("plugins/RandomItem/language/messages_" + lang + ".yml");
		if (f.exists())
			return lang;
		return "fr";
	}
	...
	public void pushMessages() {
		File f = new File("plugins/RandomItem/language/messages_" + language + ".yml");
