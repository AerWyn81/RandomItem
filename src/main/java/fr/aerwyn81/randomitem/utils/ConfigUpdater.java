...
public class ConfigUpdater {
    ...
    public static void saveOldConfig(File file, File configFile) {
        ...
        try {
            ...
            RandomItem.log.sendMessage(FormatUtils.translate("&cCannot save the old configuration file. To prevent some errors, the config will be printed below..."));
            List<String> lines = Collections.singletonList(oldConfig.saveToString());
            lines.forEach(l -> RandomItem.log.sendMessage(l));
        }
    }
}
